...
//             Quay lại
//           </Button>
//           <h1 className="text-red-primary text-xl font-bold">
//             Kết quả thanh toán
//           </h1>
//           <div></div>
//         </div>
...
//                       </span>
//                       <span className="font-medium text-white">VietQR</span>
//                     </div>
...
//                           <li>Vé điện tử đã được gửi vào tài khoản của bạn</li>
//                           <li>Bạn có thể xem vé trong mục "Vé của tôi"</li>
//                           <li>Vui lòng mang theo CMND/CCCD khi đến sự kiện</li>
//                         </ul>
//                       </div>
//                     </div>
//                   </div>
